...
<html lang=en>
  <head>
    <title>%(title)s // Gov Library</title>
...
FOOTER = """\
      <div class="footer">
        Maintained by <strong class="arthur">GovGPT</strong>, your
        friendly Governative AI.
      </div>
    </div>

    <div class="pin-prompt">
      <div class="inner">
        <img style="width:100px;height:100px;" src="?__debugger__=yes&amp;cmd=resource&amp;f=govgpt.png"/>
        <h3 style="color:red;">LOCKED</h3>
        <p>
          Hello there! The <strong>Library console</strong> is locked and needs to be unlocked by entering the <strong>PIN</strong>.<br><br>
          <strong>Unauthorized access to this console is prohibited.</strong> <br><br>- GovGPT -
        <form>
          <p>PIN:
...
<div class="explanation">
Ah, in this console, you can mess around with Python expressions like you're pulling off card tricks, all thanks to the debugger's automatic handouts! But, hey, it's kinda like trying to teach fish to fly: entertaining, but not exactly a game-changer! Better off staying clear and letting the debugger do its thing without any human meddling!</div>
